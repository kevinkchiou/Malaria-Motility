...
%   This function plots circle and curvature probability distributions of an aggregation of tracked sporozoites. There are fail-safes written in to handle non-contiguous tracks by splitting them up, or joining them together in case of short breaks. This requires four other custom-written subroutines to function, as detailed in the description.
if nargin<2
    nbin=40;
end
if nargin<3
